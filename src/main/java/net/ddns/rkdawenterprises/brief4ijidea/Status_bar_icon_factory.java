        ...
        implements StatusBarWidgetFactory
{
            ...
            implements StatusBarWidget, StatusBarWidget.IconPresentation
    {
        ...
        public @Nullable Icon getIcon()
        {
                                                            ...
                                                            .get_initialized() )
            {
                return IconManager.getInstance()
                                  .getIcon( "/icons/brief4ijidea.svg",
                                            Status_bar_widget.class );
            }
            else
            {
                return IconManager.getInstance()
                                  .getIcon( "/icons/brief4ijidea_disabled.svg",
                                            Status_bar_widget.class );
            }
        }
        ...
        private ListPopup get_popup( DataContext data_context )
        {
            ...
            ListPopup popup = JBPopupFactory.getInstance()
                                            .createActionGroupPopup(
                                                    ...
                                                    false,
                                                    ActionPlaces.POPUP );
            String ad_text = "Version " + State_component.get_version();
        ...
        private DefaultActionGroup get_action_group()
        {
            ...
            action_group_top.add( new Open_settings_action( "Settings" ) );
            action_group_top.addSeparator();
            action_group_top.add( new Browse_link_action( "Submit issue",
                                                          "https://github.com/ralphkw1/brief4ijidea/issues",
                                                          AllIcons.Vcs.Vendors.Github ) );
            action_group_top.add( new Browse_link_action( "Repository",
                                                          "https://github.com/ralphkw1/brief4ijidea",
                                                          AllIcons.Vcs.Vendors.Github ) );
